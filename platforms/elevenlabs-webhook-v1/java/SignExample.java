...
public class SignExample {
    ...
    public static void main(String[] args) throws Exception {
        String webhookSecret = "your_elevenlabs_webhook_secret";
        String payload = "{\"event\":\"audio.generation.completed\",\"data\":{\"id\":\"gen-xxx\"}}";
        String timestamp = String.valueOf(System.currentTimeMillis() / 1000);
        String signatureHeader = generateSignature(timestamp, payload, webhookSecret);
        
        System.out.println("Generated Signature Header (X-ElevenLabs-Signature):");
